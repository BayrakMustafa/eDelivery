...
{
	private org.etsi.uri._02640.soapbinding.v1_.Originators jaxbObj;
	...
	private void setFromElement(String _address, String displayName)
			throws MalformedURLException
	{
		 AttributedElectronicAddressType eAddress = SpocsFragments.createElectoricAddress(
			_address, displayName);
		 EntityDetailsType entityDetails = new EntityDetailsType();
		 entityDetails.getAttributedElectronicAddressOrElectronicAddress().add(eAddress);
